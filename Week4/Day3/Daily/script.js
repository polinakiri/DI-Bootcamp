...
const funcFilter = (car) => { return car.car_make === "Honda" }

const getCarHonda = (carInventory) => {
    carInventory.filter(funcFilter).forEach(carInventory => {console.log(`This is a ${carInventory.car_make} ${carInventory.car_model} from ${carInventory.car_year}`)});
}
